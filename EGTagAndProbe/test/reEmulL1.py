...
if not isMC: # will use 80X
    ...
    process.GlobalTag.globaltag = '101X_dataRun2_Prompt_v9' #'90X_dataRun2_v0'  #'92X_dataRun2_Prompt_v8'
...
#Martin's addition (not necessary for me)
    ...
    process.source = cms.Source("PoolSource",
		...
		'/store/data/Run2018C/EGamma/MINIAOD/PromptReco-v1/000/319/347/00000/F84C675B-E384-E811-8FB9-FA163EFA91F1.root'
                ),
