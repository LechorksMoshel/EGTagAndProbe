...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2018C/EGamma/MINIAOD/PromptReco-v1/000/319/347/00000/F84C675B-E384-E811-8FB9-FA163EFA91F1.root'),
...
process.HLTLISTPROBE = cms.VPSet(cms.PSet(
...
process.HLTLISTTAG = cms.VPSet(cms.PSet(
    HLT = cms.string('HLT_Ele32_WPTight_Gsf_v'),
    leg1 = cms.int32(11),
    leg2 = cms.int32(999),
    path1 = cms.vstring('hltEle32WPTightGsfTrackIsoFilter'),
        ...
        cms.PSet(
            idDefinition = cms.PSet(
                cutFlow = cms.VPSet(cms.PSet(
                    ...
                    mvaCuts = cms.vdouble(
                        0.972550955975, 2.97659326151, 0.26538587364, 0.95080381416, 2.66335005587, 
        ...
        cms.PSet(
            idDefinition = cms.PSet(
                cutFlow = cms.VPSet(cms.PSet(
                    ...
                    mvaCategoriesMapName = cms.InputTag("electronMVAValueMapProducer","ElectronMVAEstimatorRun2Fall17IsoV1Categories"),
                    mvaCuts = cms.vdouble(
                        0.93870703961, 2.65255852282, 0.822264716415, 0.894880292568, 2.76456703588, 
        ...
        cms.PSet(
            idDefinition = cms.PSet(
                cutFlow = cms.VPSet(cms.PSet(
                    ...
                    mvaCategoriesMapName = cms.InputTag("electronMVAValueMapProducer","ElectronMVAEstimatorRun2Fall17IsoV1Categories"),
                    mvaCuts = cms.vdouble(
                        -0.0956408614642, -0.282299169819, -0.0546668229696, -0.833466688584, -0.767700024757, 
                        -0.691730599565
                    ),
                    mvaValueMapName = cms.InputTag("electronMVAValueMapProducer","ElectronMVAEstimatorRun2Fall17IsoV1Values"),
                    needsAdditionalProducts = cms.bool(True)
...
process.Ntuplizer = cms.EDAnalyzer("Ntuplizer",
    ...
    triggerListProbe = cms.VPSet(cms.PSet(
        HLT = cms.string('HLT_Ele32_WPTight_Gsf_v'),
        leg1 = cms.int32(11),
        leg2 = cms.int32(999),
        path1 = cms.vstring('hltEle32WPTightGsfTrackIsoFilter'),
    ...
    triggerListTag = cms.VPSet(cms.PSet(
        HLT = cms.string('HLT_Ele32_WPTight_Gsf_v'),
        leg1 = cms.int32(11),
        leg2 = cms.int32(999),
        path1 = cms.vstring('hltEle32WPTightGsfTrackIsoFilter'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('NTuple_numEvent200.root')
)
...
process.caloStage2Params = cms.ESProducer("L1TCaloStage2ParamsESProducer",
    ...
    tauIsoLUTFile = cms.FileInPath('L1Trigger/L1TCalorimeter/data/Tau_Iso_LUT_Option_31_extrap_2018_FW_v10.0.0.txt'),
    tauIsoLUTFile2 = cms.FileInPath('L1Trigger/L1TCalorimeter/data/Tau_Iso_LUT_Option_31_extrap_2018_FW_v10.0.0.txt'),
...
process.NtupleSeq = cms.Sequence(process.hltFilter+process.patTriggerUnpacker+process.Ntuplizer)
...
process.electrons = cms.Sequence(process.electronMVAValueMapProducer+process.egmGsfElectronIDs+process.electronRegressionValueMapProducer)
...
process.p = cms.Path(process.electrons+process.RawToDigi+process.L1TReEmul+process.NtupleSeq)
